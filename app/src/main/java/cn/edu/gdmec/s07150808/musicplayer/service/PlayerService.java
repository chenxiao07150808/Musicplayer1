...
import cn.edu.gdmec.s07150808.musicplayer.util.PlayerHelper;
...
public class PlayerService extends Service implements Runnable {
	...
	public static final String ACTION_PLAY_BUTTON = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_PLAY_BUTTON";
	// 在点击了播放列表的时候发这个action的广播
	public static final String ACTION_PLAY_ITEM = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_PLAY_ITEM";
	// 在点击了播放列表的时候发这个action的广播
	public static final String ACTION_PLAY_INTERNET = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_PLAY_INTERNET";
	// 定义上一首，下一首action
	public static final String ACTION_PLAY_PREVIOUS = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_PLAY_PREVIOUS";
	public static final String ACTION_PLAY_NEXT = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_PLAY_NEXT";
	// 更改播放模式mode的action
	public static final String ACTION_MODE = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_MODE";
	// seekbar进度更改的action
	public static final String ACTION_SEEKBAR = "cn.edu.gdmec.s07150808.musicplayer.service.ACTION_SEEKBAR";
	...
	private void showNotification(String title, String artist) {
		...
		notifi.icon = R.drawable.notification;
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(ACTION_PLAY_ITEM)) {
				...
				serviceMusicList = intent
						.getParcelableArrayListExtra(PlayerFinal.PLAYER_LIST);
